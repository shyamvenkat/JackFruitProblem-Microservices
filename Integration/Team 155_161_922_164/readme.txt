...
This is done for both sms and email noti., where they call the "bore-url/send-offer-email".

Here an email(mentioned in user-activity-service) is sent whenever the page is reloaded(as the offers are generated based on a rule).
